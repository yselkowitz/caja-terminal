...
_install() {
	...
	#Caja Python
	mkdir -pv "$1"/usr/share/python-caja/extensions
	cp -pv ./code/caja-terminal.py "$1"/usr/share/python-caja/extensions/
	chmod -v 755 "$1"/usr/share/python-caja/extensions/caja-terminal.py
	#Doc
...
_remove() {
	...
	rm -v /usr/share/python-caja/extensions/caja-terminal.py
